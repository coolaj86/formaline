...
fproto.parseMultipartData = function( chunk ){
    ...
    for( var i = 0; i < resultsLength; i++ ){
        ...
        if( rfinish > rstart + bblength + 2 ){
            ...
            this.logger( 3, 'seems that the end of request is reached.. ! end payload index ! ' + rfinish + ' < = > ! start payload index ! ' + ( rstart + bblength + 2 ) + '\n' );
        } 
        ...
        if( fieldName ){
           ...
           this.logger( 3, ' <-- no field name founded.. \n' ); 
        }         
    } // end for
