        ...
        startParsing = function () {
            ...
            if ( ctype ) {
                ...
                if ( isUpload ) {
                    ...
                    me.req.addListener( 'close', me.closeConnection.bind( me ) );
                    me.req.addListener( 'data', me.parseMultipartData.bind( me ) );
                    me.req.addListener( 'end', me.sendResponseToMultipart.bind( me, clength ) );
                } else if ( isUrlEncoded ) {
                    // seralized fields
                    me.req.addListener( 'close', me.closeConnection.bind( me ) );
                    me.req.addListener( 'data', me.parseUrlEncodedData.bind( me ) );
                    me.req.addListener( 'end', me.sendResponseToUrlEncoded.bind( me ) );
                } else {
