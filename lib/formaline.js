...
fproto.parse = function( req, res, next ){
            ...
            try{
                if( typeof this.getSessionID === 'function' ){
                    ...
                    if( typeof sessionID !== 'string' ){
                        ...
                        //TODO security, escaping chars, check sessionID string length?
    ...
    if( ( req ) && ( typeof req === 'object' ) && ( req.body === undefined ) && ( req.method === 'POST' || req.method === 'PUT' )  && ( hs ) ){
        ...
        if( path.existsSync( this.uploadRootDir ) ){
            ...
            // uploadRootDir dir doesn't exist
        ...
        if( ctype ){   
            ...
            if( isUpload ){
                // multipart form data
                // this.logger( 1, 'formaline, boundary pattern: ' + this.boundString + ', length: ' + this.boundString.length + ' chars\n' );
    ...
    for( var i = 0; i < resultsLength; i++ ){
        ...
        if( fieldName ){
            ...
            if( fileName ) { // file field
                ...
                // TODO emitting also field event ? I don't think so.      
