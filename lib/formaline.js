...
fproto.parse = function ( req, res, next ) {
    ...
    var hs = req.headers,
        ...
        createUploadDir2 = function ( cback ) {
        ...
        startParsing = function () {
            ...
            me.logger( 1, 'formaline, HTTP Request Headers -> ' + JSON.stringify( me.req.headers, null, 4 ) );
            if ( clength ) { 
                try {
            ...
            if ( ctype ) {
                ...
                if ( isUpload ) {
                    ...
                    if ( me.req.complete ) {
                        // me.sendResponseToMultipart( me.firstChunk.length );
    ...
    if ( ( req ) && ( typeof req === 'object' ) && ( req.body === undefined ) && ( req.method === 'POST' || req.method === 'PUT' )  && ( hs ) ) {
        ...
        createUploadDir2( startParsing.bind( me ) );
    } else {
