...
fproto.parseMultipartData = function( chunk ){
    ...
    var writeToFileStream = ( function( dataPayload, cfg ){  
        ...
        checkSize = ( function( buffer, line ){
            //console.log( line, this.fileSize, this.maxSizeExceeded, this.maxFieldSize, this.fileSize + buffer.length, ( this.maxFieldSize < this.fileSize + buffer.length ) );
        ...
        if( this.fileStream ){
            if( this.chopped ){ // fileStream exists, file data is chopped
                if( resultsLength === 0 ){ // chunk is only data payload
                    ...
                    if( !checkSize( fileDataChunk, '550' ) ){
            ...
            if( fileName ) { // file field
                ...
                if( i === resultsLength - 1 ) { // last result
                        ...
                        if( this.fileStream ){
                            ...
                            if( this.bytesReceived <= this.uploadThreshold ){
                                if( chunkLength >= rfinish + 4 ){
                                    ...
                                    // TODO HERE
                                    if( !checkSize( fileDataChunk, '623' ) ){
                                        addToIncompleteList( this.fileStream );
                                    }else{                                        
                    ...
                    if( this.fileStream ){
                        ...
                        // TODO HERE                        
                        if( !checkSize( fileDataChunk, '640' ) ){
                            addToIncompleteList( this.fileStream );
                        }else{ 
