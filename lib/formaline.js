...
FPROTO.parse = function( req, res, next ){
    ...
    var hs = req.headers,
        ...
        retrieveSessionIdentifier = ( function(){ 
            try{
                if( typeof this.getSessionID === 'function' ){
                    this.getSessionID = this.getSessionID( this.req );
                    if( typeof this.getSessionID !== 'string' ){
                        this.emitException( 'warning', isUpload, 'Warning: function \'this.getSessionID\' doesn\'t return a String!', 0 );
                    ...
                    this.emitException( 'warning', isUpload, 'Warning: configuration parameter \'this.getSessionID\' must be a function!', 0 );
                    this.getSessionID = undefined;
                }  
              }catch( serr ){
        ...
        getUploadSubDirectoryName = ( function(){         
            ...
            return ( this.getSessionID ) ? ( this.getSessionID ) : ( parseInt( new Date().getTime() * ( 1 + Math.random() ) * 10 * 32, 10 ) );
        } ).bind( this ),
        
        createUploadSubDir = ( function(){
           try{ 
                //try to create a sub-directory of upload root directory
                this.uploadRootDir = this.uploadRootDir + getUploadSubDirectoryName() + '/';
                //TODO if dir already exists don't create it!!!
