                        ...
                        if(fieldName){
                            ...
                            if(fileName){//file field
                                ...
                                if( this.completedFiles.indexOf(filepath) < 0 ){ //file with the same name already exists
                                    ...
                                    this.emit('warning','formaline.parse(req,res) , this hashed filename already exists'+sha1filename+', orig filename: '+escapedFilename+', new hashed (sha1) filename: '+newSha1);
