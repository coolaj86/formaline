...
fproto.emitEvent = function ( type, obj, logLevel ) {
    ...
    me.logger( logLevel, '\033[1;33mformaline, event: \033[0m\033[32m"' + etype + '" --> \033[0m\033[1m\033[0;33m', JSON.stringify( obj ), '\033[0m' );
...
fproto.parseMultipartData = function( chunk ){
    ...
    me.req.pause();
    me.logger( 3, 'formaline, new data chunk received, request paused .. ' );
