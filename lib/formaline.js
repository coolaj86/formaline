...
var formaline = function ( config ){
    ...
    this.emitFileRemoved = ( function( sha1name, origname, path, type, size, fieldname ){
    ...
    var writeToFileStream = ( function( dataPayload, cfg ){  
        ...
        addToIncompleteList = ( function( file ){
            ...
            if( incomplete.list.indexOf( file.path ) < 0 ){
                ...
                this.emitException( 'warning', this.uploadRootDir, 'Warning <-> max upload size exceeded, this file is incomplete: ' + path.basename( file.path ), 0 );
            }
        } ).bind( this ),
