...
fproto.sendResponseToMultipart =  function( nbytes ){ 
    ...
    if( this.removeIncompleteFiles === false ){
        ...
        sendResponse( { files: groupResultsByFieldName( this.receivedFilesCollection.hash ), incomplete: groupResultsByFieldName( this.incompleteFilesCollection.hash ), fields: this.receivedFieldsCollection.list, stats: this.endResults, } );
    }else{
