            ...
            try{
                if( typeof this.getSessionID === 'function' ){
                    ...
                    if( typeof sessionID !== 'string' ){
                        this.emitException( 'warning', isUpload, 'Warning: unable to retrieve session identifier, function \'this.getSessionID( req )\' doesn\'t return a String!', 0 );        
                    }else{
                    ...
                    this.emitException( 'warning', isUpload, 'Warning: unable to retrieve session identifier, configuration parameter \'this.getSessionID\' must be a function!', 0 );

                }  
              }catch( serr ){
                  this.emitException( 'warning', isUpload, 'Warning: unable to retrieve session identifier -> ' + serr.stack, 0 );
                  return null;
              }
