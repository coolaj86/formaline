                        ...
                        if(fieldName){
                            ...
                            if(fileName){//file field
                                var escapeChars = /[\\[\](\)\{\}\/\\\|\!\:\=\?\*\+\^\$\@\""\<\>\%\\:\,\;\:\`\s\t\r\n]/g,
                                    ...
                                    nlength = escapedFilename.length;
                                    
                                    //if( nlength > 10 ){
                                    //    escapedFilename = escapedFilename.substring( nlength - 10, nlength ) ;
                                    //}
                                    var filepath = this.uploadRootDir + escapedFilename;
                                    
                                this.logger(3,'   ->field: '+fieldName[1]+', file: '+escapedFilename+', content-type: '+contentType[1]);
