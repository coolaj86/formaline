                            ...
                            for(var i = 0, ufile = this.incompleteFilesCollection.list, len = ufile.length, currfile = ufile[0]; i < len; i++, currfile = ufile[i] ){
                                fs.unlink(currfile,(function(err,cfile,i,len){
                                    if(err){
                                        ...
                                        var ifile = this.incompleteFilesCollection[path.basename(cfile)]; //TODO
                                        this.emit('fileremoved',path.basename(cfile),ifile.dir,ifile.type,ifile.rbytes,ifile.field);//TODO
