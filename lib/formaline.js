...
var setDebuggingLevel = function( dstring, form ){
    var p = '', 
        dlevels = querystring.parse( "debug:off,1:on,2:on,3:off,file:off,console:on", ',', ':' ), // debug:'on' print always : 0 level ( errors )
        flog = null,
        fpath = null
        filelogging = false
    if( dstring ){
...
var formaline = function ( config ){
    ...
    this.sha1sum = true;
    this.listeners = {};
    this.logging = 'debug:off,1:on,2:on,3:off,file:off,console:on';
